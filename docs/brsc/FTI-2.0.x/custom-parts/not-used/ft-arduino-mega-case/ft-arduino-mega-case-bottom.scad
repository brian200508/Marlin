...
module arduinoCaseBottom() {
    union() {
        ...
        translate([7.5, 0, 0])connector45mm();
        translate([97.5, 0, 0])connector45mm();

        translate([7.5, 150, 0])connector45mm();
        translate([97.5, 150, 0])connector45mm();

        translate([0, 7.5, 0])rotate([0, 0, 90])connector45mm();
        translate([0, 142.5, 0])rotate([0, 0, 90])connector45mm();

        translate([105, 7.5, 0])rotate([0, 0, 90])connector45mm();
        translate([105, 142.5, 0])rotate([0, 0, 90])connector45mm();
    }
}
