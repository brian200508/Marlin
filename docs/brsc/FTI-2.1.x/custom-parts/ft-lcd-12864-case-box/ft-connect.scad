 ...
 * 
 * Fischertechnik connectors generator openscad by grumson is licensed under the Creative Commons - Attribution license.
...
//ftConnectFti2(NumberOfSegments = 2, Length=30);
...
module ftConnectorMale() {
    translate([0, 0, -30])difference() {
        import("ft-connector-basic.stl");
        cube(size=60, center=true);
    }
}

/**
 * Create Fischertechnik connector for the brsc FTI-2.x.x printer.
 */
module ftConnectFti2(
    NumberOfSegments = 1,
    Length = 15,
    TopConnector = "none",
...
/**
 * Create Fischertechnik connector.
 */
module ftConnect(
    NumberOfSegments = 1,
    Length = 15,
    ...
    rotate([RotateX, RotateY, RotateZ]) {
        ...
        difference(){
            ...
            union() {
                ...
                translate([-7.5/2, 0, 0])roundedCube(size=[ 7.5, width, Length], radius=borderDepth/2, center=true, apply_to=borderApply);
