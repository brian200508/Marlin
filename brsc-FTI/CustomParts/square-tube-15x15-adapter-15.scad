...
module ftiSpuareTubeAdapter15x15(ftiEndCapLength=15) {
    ...
    union() {
        ...
        difference() {
            ...
            // axis
            translate([dBlock/2,dFti/2,0])cylinder(h=ftiEndCapLength, d=dCyl);
            translate([dBlock/2,dBlock-dFti/2,0])cylinder(h=ftiEndCapLength, d=dCyl);
            translate([dBlock-dFti/2,dBlock/2,0])cylinder(h=ftiEndCapLength, d=dCyl);
            translate([dFti/2,dBlock/2,0])cylinder(h=ftiEndCapLength, d=dCyl);
            // space
